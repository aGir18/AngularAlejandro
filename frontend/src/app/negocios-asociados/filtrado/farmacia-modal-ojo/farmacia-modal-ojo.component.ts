...
@Component({
  selector: 'app-farmacia-modal-ojo',
  templateUrl: './farmacia-modal-ojo.component.html',
  styleUrls: ['./farmacia-modal-ojo.component.css']
})
export class FarmaciaModalOjoComponent implements OnInit {
