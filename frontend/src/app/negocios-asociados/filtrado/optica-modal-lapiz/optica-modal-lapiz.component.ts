...
@Component({
  selector: 'app-optica-modal-lapiz',
  templateUrl: './optica-modal-lapiz.component.html',
  styleUrls: ['./optica-modal-lapiz.component.css']
})
export class OpticaModalLapizComponent implements OnInit {
