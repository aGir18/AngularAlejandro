...
@Component({
  selector: 'app-farmacia-modal-lapiz',
  templateUrl: './farmacia-modal-lapiz.component.html',
  styleUrls: ['./farmacia-modal-lapiz.component.css']
})
export class FarmaciaModalLapizComponent implements OnInit {
