...
@Component({
  selector: 'app-filtrado-optica-item',
  templateUrl: './filtrado-optica-item.component.html',
  styleUrls: ['./filtrado-optica-item.component.css']
})
export class FiltradoOpticaItemComponent implements OnInit {
